        ...
        <div class="row">
	      <form action="/LibraryManager/emprunt_add" method="post" class="col s12">
	        <div class="row">
	          <div class="input-field col s6">
	            <select id="idLivre" name="idLivre" class="browser-default">
                  ...
                  <c:forEach var="livre" items="${livreDispo}" >
	          ...
	          <div class="input-field col s6">
	            <select id="idMembre" name="idMembre" class="browser-default">
                  ...
                  <c:forEach var="membre" items="${membreDispo}">
	        ...
	        <div class="row center">
	          <a href="dashboard"><button class="btn waves-effect waves-light" type="submit">Enregistrer l'emprunt</button></a>
